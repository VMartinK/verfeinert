...
This directory contains official reproducible examples for Verfeinert.

## Official Examples

- `CX01_reproduction/`: CX-01 reproduction with a fast smoke profile and
  documented full scientific settings.
